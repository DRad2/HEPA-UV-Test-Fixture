...
cansend_command = "cansend can1 5A1#00.00.00.00.00.00.00.00"
...
try:
    ...
    for _ in range(4):  # Adjust the number of seconds as needed
...
# Wait for the candump process to finish if it hasn't already
